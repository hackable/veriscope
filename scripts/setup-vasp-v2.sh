...
full_install() {
	...
	echo_info "  1. Create admin user: sudo scripts/setup-vasp-v2.sh create_admin"
	echo_info "  2. Install address proofs: sudo scripts/setup-vasp-v2.sh install_address_proofs"
	echo_info ""
