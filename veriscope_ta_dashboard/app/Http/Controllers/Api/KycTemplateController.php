...
class KycTemplateController extends Controller
{
    ...
    public function kyc_template_details(Request $request)
    {
        ...
        $list = [['field' => 'ID', 'data'  => $result['id']],
                    ...
                    ['field' => 'Sender User Signature Hash', 'data'  => $result['sender_user_signature_hash']],
                    ['field' => 'Sender User Signature', 'data'  => $result['sender_user_signature']],
                    ...
                    ['field' => 'Sender API_URL', 'data'  => $result['sender_ta_url']],
